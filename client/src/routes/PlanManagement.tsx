import { Button, IconButton, List, ListIcon, ListItem, UnorderedList } from "@chakra-ui/react"
...
export default function PlanManagement() {
    ...
    const handleChange = useCallback((event: any) => setValue(event.target.value), [setValue])
